...
func CreateConsolidatedPPEDescription(detections []models.Detection, violationCounts map[string]int) string {
	...
	for violation, count := range violationCounts {
		...
		case strings.Contains(strings.ToLower(violation), "vest"):
			description.WriteString(fmt.Sprintf("❌ Missing Safety Vest: %d people\n", count))
		case strings.Contains(strings.ToLower(violation), "helmet"):
			description.WriteString(fmt.Sprintf("❌ Missing Safety Helmet: %d people\n", count))
		case strings.Contains(strings.ToLower(violation), "glasses"):
			description.WriteString(fmt.Sprintf("❌ Missing Safety Glasses: %d people\n", count))
		case strings.Contains(strings.ToLower(violation), "gloves"):
			description.WriteString(fmt.Sprintf("❌ Missing Safety Gloves: %d people\n", count))
		default:
			description.WriteString(fmt.Sprintf("❌ %s: %d people\n", strings.Title(violation), count))
		}
	}
...
func CreatePPEDescription(detection models.Detection) string {
	...
	for _, violation := range detection.Violations {
		switch {
		case strings.Contains(strings.ToLower(violation), "vest"):
			violationDetails = append(violationDetails, "❌ Missing Safety Vest")
		case strings.Contains(strings.ToLower(violation), "helmet"):
			violationDetails = append(violationDetails, "❌ Missing Safety Helmet")
		case strings.Contains(strings.ToLower(violation), "glasses"):
			violationDetails = append(violationDetails, "❌ Missing Safety Glasses")
		case strings.Contains(strings.ToLower(violation), "gloves"):
			violationDetails = append(violationDetails, "❌ Missing Safety Gloves")
		default:
			violationDetails = append(violationDetails, fmt.Sprintf("❌ %s", strings.Title(violation)))
		}
	}
